...
public class Lab10 {
    ...
    public static int factorial(int n) {
        ...
        // Implement the recursive case, return n * factorial(n - 1)
    ...
    public static int countEars(int n) {
        ...
        // Implement the base case, if n is 0, return 0
        if(n == 0){
            return 0;
        }

        // Recursive case: 2 ears for this rabbit + ears for the rest
        // Implement the recursive case, return 2 + countEars(n - 1)
    ...
    public static int fibonacci(int n) {
        ...
        // Implement the recursive case, return fibonacci(n - 1) + fibonacci(n - 2)
    ...
    public static int specialEars(int n) {
        ...
        // If n is odd, return 2 + specialEars(n - 1);
        if ( n % 2 ==1){
            return 2 + specialEars(n -1);
        }
        //Otherwise, return 3 + specialEars(n - 1);
        else{ 
    ...
    public static int triangleBlocks(int n) {
        ...
        // Implement the recursive case, return n + triangleBlocks(n - 1)
    ...
    public static int sumDigits(int n) {
        ...
        // Implement the base case, if n is less than 10, return n
        if ( n < 10){
            return n;
        }
        // Recursive case: rightmost digit + sum of the rest
        // Implement the recursive case, return (n % 10) + sumDigits(n / 10)
    ...
    public static int countSevens(int n) {
        ...
        // Otherwise, return countSevens(n / 10);
        else{
    ...
    public static int countEights(int n) {
        ...
        // Create variables rightDigit and secondRightDigit
        int rightDigit;
        int secondRightDigit;

        // Assign rightDigit to n % 10
        rightDigit = n % 10;
        // Assign secondRightDigit to (n / 10) % 10
        secondRightDigit = (n/10) % 10;

        // Check special case: 8 preceded by another 8
        // If rightDigit == 8 and secondRightDigit == 8, return 2 + countEights(n / 10);
        ...
        // Otherwise, return countEights(n / 10);
        else{
    ...
    public static int countHi(String str) {
        ...
        // Implement the base case, if str.length() < 2, return 0
        if(str.length() < 2){
            return 0;
        }
        ...
        // Otherwise, check the next character by calling countHi(str.substring(1));
        else{
    ...
    public static String replaceChar(String str) {
        ...
        // Implement the base case, if str.length() == 0, return ""
        if(str.length() == 0){
            return "";
        ...
        // Otherwise, return str.charAt(0) + replaceChar(str.substring(1));
        else{
    ...
    public static String removeChar(String str) {
        ...
        // Otherwise, return str.charAt(0) + removeChar(str.substring(1));
        else{
    ...
    public static String markPairs(String str) {
        ...
        // Implement the base case, if str.length() <= 1, return str
        if(str.length() <= 1){
            return str;
        }
        ...
        // Otherwise, return str.charAt(0) + markPairs(str.substring(1));
        else{
            return str.charAt(0) + markPairs(str.substring(1));
        }
        //throw new UnsupportedOperationException("Not implemented yet");
    ...
    public static String deduplicate(String str) {
        ...
        // **Had to implement this for the method to work**
        if(str.length() == 1){
            return str;
        }
        ...
        // Otherwise, return str.charAt(0) + deduplicate(str.substring(1));
    ...
    public static int countHiSpecial(String str) {
        ...
        // Otherwise, return countHiSpecial(str.substring(1));
        else{
    ...
    public static int substringLength(String str, String sub) {
        ...
        // Implement the base case, if str.length() < sub.length(), return 0
        if(str.length() < sub.length()){
            return 0;
        }
        // Check if string starts and ends with the substring
        // Create boolean variables startsWith and endsWith
        boolean startsWith;
        boolean endsWith;
        // Assign startsWith to str.startsWith(sub)
        startsWith = str.startsWith(sub);
        // Assign endsWith to str.endsWith(sub)
        endsWith = str.endsWith(sub);

        // If both are true, return str.length()
        if (startsWith && endsWith){
            return str.length();

        }
        // Try removing first character
        // Create a variable removeFirst and assign it to substringLength(str.substring(1), sub)
        int removeFirst = substringLength(str.substring(1), sub);
        // Try removing last character
        // Create a variable removeLast and assign it to substringLength(str.substring(0, str.length() - 1), sub)
        int removeLast = substringLength(str.substring(0, str.length() -1), sub);
        // Return the larger result
        // Return the maximum of removeFirst and removeLast
    ...
    public static void towerOfHanoi(int n, char source, char auxiliary, char target) {
        ...
        // Implement the base case, if n is 1, print Move disk 1 from source to target
        if (n == 1) {
            System.out.println("Move disk 1 from " + source + " to " + target);
            return;
        }
        // Move n-1 disks from source to auxiliary using target as temporary
        // Call towerOfHanoi(n - 1, source, target, auxiliary);
        ...
        // Call towerOfHanoi(n - 1, auxiliary, source, target);
